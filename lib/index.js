...
module.exports = function (cmd, options) {
  ...
  devtoolsOptions['debug-brk'] = options['nodeArgs'].includes('--inspect-brk')
...
const inspectProcess = function (cmd, options, devtools) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    proc.stderr.on('data', (data) => {
      ...
      const DebugBrkDeprecation = dataStr.indexOf('DeprecationWarning: `node --inspect --inspect-brk` is deprecated. Please use `node --inspect-brk` instead.') !== -1
